 ...
 */
export const ADD_EXPENSE_TITLE_SECTION = "Ajouter une dépense";
export const EXPENSE_DETAILS_LABEL = "Détails";
...
export const ADD_EXPENSE_TEXT_MOBILE = "Ajouter";
export const ADD_EXPENSE_TEXT_DESKTOP = "+";
export const REMOVE_EXPENSE_TEXT_MOBILE = "Retirer";
export const REMOVE_EXPENSE_TEXT_DESKTOP = "-";
